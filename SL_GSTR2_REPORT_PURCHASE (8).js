...
var data_bill = data_bill.filter(function (invoice) {
  return gstin_val.indexOf(invoice.subsidiarytaxregnum) !== -1;
			...
			var fileContent = '';
				...
				for (var p = 0; p < data_bill.length; p++) {
                  ...
                  fileContent += data_bill[p].tranid + DELIMITER;
					//fileContent += escapeCSV(data_bill[p].tranid) + DELIMITER;
	  ...
	  var FiltersArray_bill=[  ["type","anyof","VendBill","VendCred","CashSale"], 
      "AND", 
      ["mainline","is","T"], 
      "AND", 
       ["postingperiod","abs",custpage_period], 
      ...
      ["memorized","is","F"], 
			...
			var FiltersArray=[  ["type","anyof","CustInvc","CustCred","CashSale"], 
      "AND", 
      ["mainline","is","T"], 
      "AND", 
       ...
       sublist.setSublistValue({  id: 'custpage_doc_type', line: lineNum, value: type });
        ...
        function escapeCSV(value) {
            if (value === null || value === undefined) {
                return '""'; // Return empty quotes for null/undefined
            }
